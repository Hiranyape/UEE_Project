...
class AddFosterJorney extends StatefulWidget {
  ...
  const AddFosterJorney({super.key, required this.onTap});
...
class _AddFosterJorneyState extends State<AddFosterJorney> {
  ...
  String? file;
  late Cloudinary cloudinary; // To store the selected image path.
  ...
  if (title.text.isNotEmpty || description.text.isNotEmpty) {
    if (selectedImagePath != null) {
      ...
      await FirebaseFirestore.instance.collection("JourneyTracker").add({
        ...
        setState(() {
          ...
          file=null; // Clear the selected image path.
        });
      }).catchError((error) {
