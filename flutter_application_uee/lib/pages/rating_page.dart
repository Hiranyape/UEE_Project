...
//                 context,
//                 MaterialPageRoute(
//                     builder: (context) => RatingDetailsPage(
//                           fosterEmail: widget.email,
//                         )),
//               );
//             },
...
class _RatingPageState extends State<RatingPage> {
  ...
  Future<void> _getImage() async {
    ...
    if (pickedFile != null) {
      setState(() {
        _userImageProvider = FileImage(File(pickedFile.path));
      });
    }
  }
  ...
  void rateMyService(String rating) {
    // Store the rating in Firebase or your preferred database.
    firestore.collection("rate_my_service").add({
      "rating": rating,
      "email": widget.email, // Add the foster email
      "timestamp": ServerValue.timestamp,
    });
          ...
          title: Row(
            children: [
              GestureDetector(
                ...
                child: CircleAvatar(
                  radius: 50,
                  backgroundImage: _userImageProvider == null
                      ? AssetImage('assets/images/profile_Default.jpg')
                      : _userImageProvider,
                ),
              ),
